  ...
  return (
    <div className="bg-slate-300 rounded-md m-4 md:m-8 md:w-[875px] md:mx-auto">
      <div className="grid md:grid-cols-2">
        <div className="ml-28 mt-5 mb-5 md:ml-24 md:mt-4 md:mb-4 bg-white h-[200px] w-[155px] md:h-[335px] md:w-[275px] lg:h-[385px] lg:w-[300px] rounded-xl shadow-2xl">
          <img
            src="/images/wedding/wed-5.jpg"
            alt=""
            className="h-[175px] md:h-[315px] lg:h-[350px] ml-3 md:ml-5 mt-3 md:mt-3 object-cover rounded-lg shadow-inner"
          />
        </div>
      ...
      <div className="w-[250px] md:w-[575px] text-center ml-16 md:ml-36 mt-2">
