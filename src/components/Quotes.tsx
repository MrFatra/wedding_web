const Quotes = () => {
    return (
        <div className="mx-8 mb-10 bg-[#FFFDD7] p-10">
            <div className="flex items-center justify-center mb-10">
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="#66474a" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-3xl font-semibold border-[3px] border-dashed p-5 border-grack text-center flex flex-col gap-5">
