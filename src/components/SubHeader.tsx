const SubHeader = () => {
  return (
    <div className="bg-slate-300 rounded-lg mt-3 shadow-2xl p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-4 md:px-20">
        <div className="cursor-pointer">
          <img
            ...
            alt="wedding1"
            className="h-[435px] md:h-[200px] lg:h-[350px] object-cover w-full rounded shadow-xl"
          />
        </div>
        <div className="cursor-pointer">
          <img
            ...
            alt="wedding2"
            className="h-[175px] md:h-[200px] lg:h-[350px]  object-cover w-full rounded shadow-xl"
          />
        </div>
        <div className="cursor-pointer">
          <img
